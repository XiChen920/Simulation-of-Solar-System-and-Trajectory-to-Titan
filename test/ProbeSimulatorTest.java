...
import phase3.calculations.ProbeSimulator;
import phase3.calculations.ProbeSimulatorInterface;
import phase3.calculations.Vector3d;
import phase3.calculations.Vector3dInterface;
...
class ProbeSimulatorTest {
    ...
    @Test void testTrajectoryOneDayX() {
        ...
        System.out.println("Distance between target and actual location: "+Math.abs(x1-trajectory[1].getX()));
    ...
    @Test void testTrajectoryOneYearX() {
        ...
        System.out.println("Distance between target and actual location: "+Math.abs(x366-trajectory[366].getX()));
